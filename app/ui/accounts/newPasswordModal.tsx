...
export default function NewPasswordModal({account, password}: {account: string, password: string}) {
    const [showToast, setShowToast] = useState(false);

    return(
        <dialog id={`${account}-password-modal`} className="modal">
            <div className="modal-box flex flex-col items-center gap-5">
                
                <div className="flex gap-1 text-xl">
                    <h1>Neues Passwort von</h1>

...
export default function DownloadButton({token}: {token: string}) {
    return(
        <>
            <a className="btn xs:w-[200px] xs:h-[80px] w-[250px] h-[50px] bg-white shadow-sm rounded-lg flex justify-center items-center" href={`https://image-proxy.simon-rosebrock.workers.dev/download?token=${token}`}>
